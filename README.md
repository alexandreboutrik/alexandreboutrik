...
<table>
    <tr>
        ...
        <td valign="middle">
            <a href="https://github.com/alexandreboutrik/dassh">dassh</a> is a live SSH monitoring dashboard that watches user commands and program output across multiple sessions in a real-time terminal interface.
        </td>
    </tr>
</table>

### KuREos &nbsp;<kbd><img width="16" height="16" src="./media/haskell.png" /></kbd>

<table>
    <tr>
        <td width="128" height="128" align="center" valign="middle">
            <img width="128" height="128" align="left" src="./media/KuREos.png" />
        </td>
        <td valign="middle">
            <a href="https://github.com/alexandreboutrik/KuREos">KuREos</a> is a offline, terminal-based compiler explorer inspired by <a href="https://godbolt.org">GodBolt's Compiler Explorer</a>. It allows you to write high-level source code and instantly view the raw, compiled assembly generated by your local toolchains directly within your terminal.
        </td>
    </tr>
</table>
